      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-24">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          {adamCaseStudy.technologies.map((technology, index) => (
            <div
              key={technology}
              className="group rounded-xl border border-white/[0.07] bg-[#0d1210] p-5 transition-all duration-300 hover:-translate-y-1 hover:border-[#39ff88]/30 hover:shadow-[0_10px_34px_rgba(0,0,0,0.35),0_0_22px_rgba(57,255,136,0.08)]"
            >
