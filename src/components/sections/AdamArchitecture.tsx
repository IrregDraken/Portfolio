          ...
          <div className="grid gap-4 lg:grid-cols-4">
            {adamCaseStudy.architecture.map((layer, index) => (
              <div key={layer.name} className="relative">
                <div className="relative z-10 h-full rounded-2xl border border-white/[0.07] bg-[#0d1210] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#39ff88]/30 hover:shadow-[0_10px_34px_rgba(0,0,0,0.35),0_0_22px_rgba(57,255,136,0.08)]">
